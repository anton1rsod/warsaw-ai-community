...
//
// Output: ../assets/subploters-lockup.svg

const opentype = require('opentype.js');
const fs = require('fs');
const path = require('path');

const FONT_PATH = 'node_modules/geist/dist/fonts/geist-sans/Geist-SemiBold.ttf';
...
<!--
  ...
  Source: community/brand/.scratch/build-lockup.js (regenerate with: node build-lockup.js)
