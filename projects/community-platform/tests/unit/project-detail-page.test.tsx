...
const src = readFileSync(
  resolve(__dirname, "../../app/projects/[slug]/page.tsx"),
  "utf8",
);

describe("project detail page v0.9 — warm, no dark:/scaffolding (H99)", () => {
  ...
  it("ThankButton referenced but not modified (imported from shared component)", () => {
    expect(src).toMatch(/ThankButton/);
  });
});
