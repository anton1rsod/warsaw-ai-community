...
| [Pulse](projects/pulse/README.md) | `projects/pulse/` | **Building** — P2 shipped (Notion mirror + Tasks export + digest) | Anton | P3 automation (`pulse.yml`); live runs need one-time Notion setup (`SETUP.md`) | P3 + §10.2 live verification |
