...
> **Lead = accountable DRI** (decision owner per project). "Active drivers" (who's hands-on now) live in the repo-wide [`STATE.md`](STATE.md).
...
| [Pulse](projects/pulse/README.md) | `projects/pulse/` | **Built (dormant)** — plan 22/22; automation merged, no-op until activated | Anton | Live activation (Anton): GitHub secrets (`SETUP.md` §5) on paid Notion account | First live runs + §10.2/§10.3 verification |
